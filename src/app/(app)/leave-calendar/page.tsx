...
import { AdminCalendarScreen } from "@/components/admin/AdminCalendarScreen";
  ...
  if (!employee) {
    return (
      <div className="rounded-[13px] border border-dashed border-[#C9CDD2] bg-card px-6 py-[52px] text-center">
        <div className="text-[15px] font-semibold">Sign in to view the org-wide calendar</div>
        <Link
          href="/login"
    ...
    return (
      <div className="rounded-[13px] border border-dashed border-[#C9CDD2] bg-card px-6 py-[52px] text-center">
        ...
        <div className="mx-auto mt-[8px] max-w-[360px] text-[13px] leading-relaxed text-muted">
          The organisation-wide leave calendar is only available to Admin/HR accounts.
        </div>
      </div>
    );
  }
